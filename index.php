...
<head><title>Madurai Covid 19 Tracker</title>
  <meta charset="utf-8">
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid ">
    <div class="navbar-header">
      <a class="navbar-brand text-dark" href="#myPage"><strong>MADURAI COVID-19 Tracker</strong></a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
     ...
     <li>   <a href='location map/sylhet.html'>Uthangudi</a></li>
        ...
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#">COVID-19 
...
<div id="#" class="bg-1">
  <div class="container">
    <h3 class="text-center"> MADURAI COVID-19 TRACKER </h3>
  <p class="text-center"><em>COVID-19 Tracker exclusively for Maduari!!!</em></p>
    <p class="text-center">MADURAI COVID-19 TRACKER is exclusively done to give 
	update info on the active case and new cases getting reported in Madurai.<strong 
  ...
  <div class="w3-container w3-content w3-padding-64" style="max-width:800px"  id="contact">
    ...
    <div class="w3-row w3-padding-32">
      <div class="w3-col m6 w3-large w3-margin-bottom">
        <i class="fa fa-map-marker" style="width:30px"></i>Maduari, Tamilnadu<br>
        <i class="fa fa-phone" style="width:30px"></i> Phone: +91 9876543213<br>
        <i class="fa fa-envelope" style="width:30px"> </i> Email:  quaranteam@gmail.com<br>
      </div>
      <?php
...
<footer class="text-center">
  ...
  <p>Copyright<a  data-toggle="tooltip" title="quaranteam">@Quaranteam</a></p> 
</footer>
<script>
